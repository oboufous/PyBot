...
parser.add_argument('-d', '--density', type=float, metavar = "d", help='Targetted density of walls', default=0.60)
parser.add_argument('-p', '--pieces', type=int, metavar = "p", help='Number of pieces of cheese', default=21*15-2)
parser.add_argument('--nonsymmetric', action="store_true", help='Do not enforce symmetry of the maze')
parser.add_argument('-md', '--mud_density', type=float, metavar = "md", help='Mud density', default=0.01)
